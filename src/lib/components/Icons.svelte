<script>
    ...
    let color = path == "/"+cypher ? "#00FF62" : "white";
...
{#if cypher == "binary"}
    <svg style="--color: {color}" class="icon" id="binary" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 78 100">
...
{:else if cypher == ""}
    <svg style="--color: {color}" class="icon" id="home" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 97.37 96.85">
...
{:else if cypher == "morse"}
    <svg style="--color: {color}" class="icon" id="morse" data-name="Layer 3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
...
{:else if cypher == "caesar"}
    <svg style="--color: {color}" class="icon" id="caesar" data-name="Layer 4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
